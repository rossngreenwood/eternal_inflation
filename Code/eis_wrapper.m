function eis_wrapper(...
    ...
    if nargin < 8,  lambdascreen = true;    end
    if nargin < 9,  fixLambda = false;      end
    if nargin < 10,  fixQ = false;           end
    if nargin < 11, measure = 'B';          end
    if nargin < 12, n_tunnel_max = 1;       end
